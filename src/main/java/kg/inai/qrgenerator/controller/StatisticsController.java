...
public class StatisticsController {
    ...
    public ResponseEntity<RestResponse> getByFullName(@PathVariable Long groupId,
    ...
    public ResponseEntity<RestResponse> getByScoreAsc(@PathVariable Long groupId,
                                                      @PathVariable LocalDate from,
                                                      @PathVariable LocalDate till) {
    ...
    public ResponseEntity<RestResponse> getByScoreDesc(@PathVariable Long groupId,
                                                       @PathVariable LocalDate from,
                                                       @PathVariable LocalDate till) {
    ...
    public ResponseEntity<RestResponse> getByFullNameSubjectId(@PathVariable Long groupId,
                                                      @PathVariable LocalDate from,
                                                      @PathVariable LocalDate till,
    ...
    public ResponseEntity<RestResponse> getByScoreAscSubjectId(@PathVariable Long groupId,
                                                      @PathVariable LocalDate from,
                                                      @PathVariable LocalDate till,
                                                      @PathVariable Long subjectId) {
    ...
    public ResponseEntity<RestResponse> getByScoreDescSubjectId(@PathVariable Long groupId,
                                                       @PathVariable LocalDate from,
                                                       @PathVariable LocalDate till,
                                                       @PathVariable Long subjectId) {
